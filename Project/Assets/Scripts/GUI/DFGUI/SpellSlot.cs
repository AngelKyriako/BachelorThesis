...
public class SpellSlot : MonoBehaviour
{
	...
	void OnEnable()
	{
        //skill = GameManager.Instance.MyCharacterModel.GetSkill((CharacterSkillSlot)slot);
		refresh();
	}
	...
	void Update()
	{
		...
		{
            if (Input.GetKeyDown((KeyCode)(this.slot + 48)))
			{
				castSpell();
			}
		}
	...
	private void refresh()
	{
		...
		label.Text = ((CharacterSkillSlot)this.slot).ToString();
